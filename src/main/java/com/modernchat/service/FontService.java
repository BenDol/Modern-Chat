...
public class FontService implements ChatService
{
    ...
    public void startUp() {
        defaultFontsMap = Map.ofEntries(
            entry(FontStyle.RUNE,              FontManager.getRunescapeFont()),
            entry(FontStyle.RUNE_SMALL,            FontManager.getRunescapeSmallFont()),
            entry(FontStyle.RUNE_BOLD,             FontManager.getRunescapeBoldFont()),
            // Open Sans
            entry(FontStyle.OPEN_SANS,         loadFont(BASE_FONT_PATH + "Open_Sans/OpenSans-Regular.ttf")),
            ...
            entry(FontStyle.OPEN_SANS_D,       loadFont(BASE_FONT_PATH + "Open_Sans/OpenSans_Condensed-Regular.ttf")),
            ...
            // Roboto
            entry(FontStyle.ROBOTO_D,          loadFont(BASE_FONT_PATH + "Roboto/RobotoCondensed-Regular.ttf")),
            ...
            entry(FontStyle.ROBOTO_D_BLACK,          loadFont(BASE_FONT_PATH + "Roboto/RobotoCondensed-Black.ttf")),
            // Source Sans 3
            entry(FontStyle.SRC_SANS,          loadFont(BASE_FONT_PATH + "Source_Sans_3/SourceSans3-Regular.ttf")),
            entry(FontStyle.SRC_SANS_BLACK,          loadFont(BASE_FONT_PATH + "Source_Sans_3/SourceSans3-Black.ttf")),
            ...
            // IBM Plex Sans
            entry(FontStyle.IBM_PLEX,          loadFont(BASE_FONT_PATH + "IBM_Plex_Sans/IBMPlexSans-Regular.ttf")),
            ...
            entry(FontStyle.IBM_PLEX_D,        loadFont(BASE_FONT_PATH + "IBM_Plex_Sans/IBMPlexSans_Condensed-Regular.ttf")),
            ...
            // Fira Sans
            entry(FontStyle.FIRA_SANS,         loadFont(BASE_FONT_PATH + "Fira_Sans/FiraSans-Regular.ttf")),
            entry(FontStyle.FIRA_SANS_BOLD,        loadFont(BASE_FONT_PATH + "Fira_Sans/FiraSans-Bold.ttf")),
            entry(FontStyle.FIRA_SANS_BLACK,         loadFont(BASE_FONT_PATH + "Fira_Sans/FiraSans-Black.ttf")),
            ...
            entry(FontStyle.ATKIN_HYPER,       loadFont(BASE_FONT_PATH + "Atkinson_Hyperlegible/AtkinsonHyperlegible-Regular.ttf")),
            entry(FontStyle.ATKIN_HYPER_BOLD,      loadFont(BASE_FONT_PATH + "Atkinson_Hyperlegible/AtkinsonHyperlegible-Bold.ttf")),
            // Lexend
            entry(FontStyle.LEXEND,            loadFont(BASE_FONT_PATH + "Lexend/Lexend-Regular.ttf")),
            entry(FontStyle.LEXEND_BOLD,           loadFont(BASE_FONT_PATH + "Lexend/Lexend-Bold.ttf")),
            entry(FontStyle.LEXEND_BLACK,            loadFont(BASE_FONT_PATH + "Lexend/Lexend-Black.ttf")),
