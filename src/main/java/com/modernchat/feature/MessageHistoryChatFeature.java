...
import static com.modernchat.feature.MessageHistoryChatFeature.*;
...
{
	@Override
	public String getConfigGroup() { return "featureMessageHistory"; }
	...
	@Override
	protected MessageHistoryChatFeatureConfig extractConfig(ModernChatConfig cfg)
	{
	...
	public void keyPressed(KeyEvent e)
	{
		clientThread.invoke(() -> {
			...
			e.consume(); // only consume when chat input is active
